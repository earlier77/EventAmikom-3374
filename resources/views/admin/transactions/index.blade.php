...
<div class="mb-8">
    ...
    <p class="text-slate-500 font-medium">Pantau data pemesanan tiket dari pelanggan.</p>
</div>
            ...
            <tbody class="divide-y border-t">
                @forelse($transactions as $trx)
                    <tr class="hover:bg-slate-50/50 transition">
                        <td class="px-8 py-6">
                            <span class="font-mono font-bold px-3 py-1 rounded-lg text-sm bg-indigo-50 text-indigo-600">
                                {{ $trx->order_id }}
                            </span>
                        </td>
